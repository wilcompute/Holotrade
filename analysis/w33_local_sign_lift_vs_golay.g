...
if allok then
  out := Concatenation(
    ...
    "  \"crossTrackTernaryGolay\": \"the W33-Theory track has a ternary Golay ",
    "result -- w33_ternary_golay_m12_grunbaum.py -- placing the [12,6,6]_3 code, ",
    "its 132 hexads as S(5,6,12), and 2.M12 on TWELVE points. Those are a ",
    "DIFFERENT twelve: the K12 / Grunbaum vertex-figure gap, reached by a genus ",
    "argument, not the twelve neighbours of a point of W(3,3). There is no ",
    "contradiction. But that file argues from parameters -- 12 = k, and the ",
    "structure on 12 points is the q=3 ternary Golay, the substrate-natural ",
    "perfect code -- and this computation shows that inference is not automatic: ",
    "for the most canonical twelve-point set the substrate offers, a point's own ",
    "neighbourhood, the geometry's group and its own sign lift do NOT produce ",
    "the code. Twelve points over F_3 is not by itself enough; which twelve ",
    "matters.\",\n",
