...
FOURTH, AND THIS IS THE STRUCTURE.  That relation says 1_L - 1_{L^perp} lies in
ker(N^T). All 45 of them do, and their rank is 15 = dim ker(N^T). So

        ker(N^T) is SPANNED by the 45 octet differences.

The 15-dimensional kernel that has been sitting behind every excess argument in
this thread is generated by exactly the objects the L u L^perp line of work was
already about.
    ...
    if args.write:
        ...
        rec = {
            ...
            "theKernelResult": (
                ...
                "objects the L u L^perp work was already about."),
