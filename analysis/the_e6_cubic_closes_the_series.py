    ...
    if "--write" in sys.argv:
        ...
        with open(p, "w") as fh:
            json.dump({
                ...
                "nowRealisedExplicitlyByTheOtherTrack": ("this file argued the "
                    "15- and 27-dimensional members are two rungs of ONE series, "
                    "abstractly. The parallel track has since made the 15-in-27 "
                    "step concrete and coefficient-by-coefficient: "
                    "Theory-of-Everything fdc9f1d75 / 8a4933dde, "
                    "analysis/w33_all36_pfaffian_double_six_sections.py, proves "
                    "that for EVERY one of the 36 Schlaefli double-sixes D there "
                    "is an explicit signed coordinate gauge on its 15-point "
                    "complement with C_E6 restricted to S_D equal to Pf_6 -- the "
                    "15 surviving Cartan-cubic terms being exactly the 15 "
                    "synthemes, the sign system having rank 10 with five gauge "
                    "bits, and all 36 sections distinct. Their own boundary "
                    "records that 'the Jordan/Severi naming is classical "
                    "interpretation'. So the ladder is not merely a series two of "
                    "whose rungs the corpus happened to hold: the 27-dimensional "
                    "cubic literally CUTS 36 copies of the 15-dimensional one, "
                    "and 1de360304 then proves the whole 36-object chain -- 36 "
                    "spreads, 36 double-sixes, 36 doily complements, 36 Pfaffian "
                    "sections -- PSp(4,3)-equivariant"),
                "timingAndOwnership": ("their material POSTDATES this file: "
                                       "c6d1077 landed 2026-09-05 11:17:12 and "
                                       "9a202a2 at 12:27:19, while fdc9f1d75 "
                                       "landed at 13:06:31. So the searches "
                                       "reported in priorArtSearched were "
                                       "accurate WHEN MADE -- the corpus did not "
                                       "then contain the Pfaffian-section "
                                       "material -- and that statement is now "
                                       "SUPERSEDED rather than wrong. By the "
                                       "corpus ownership rule the earlier commit "
                                       "owns the observation and the later one "
                                       "cites it; here the later one is also "
                                       "strictly stronger, so the citation runs "
                                       "the other way too and this file defers to "
                                       "their coefficient-level theorem"),
