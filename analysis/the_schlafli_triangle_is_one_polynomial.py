    ...
    if "--write" in sys.argv:
        ...
        with open(p, "w") as fh:
            json.dump({
                ...
                "noveltyHedgeWithdrawn": ("the hedge below is WITHDRAWN. The "
                                          "identification is PUBLISHED: "
                                          "Levay, Saniga and Vrana, 'Black Hole "
                                          "Entropy and Finite Geometry' "
                                          "(arXiv:0903.0541), state that 'the 27 "
                                          "charges correspond to the points and "
                                          "the 45 terms in the entropy formula to "
                                          "the lines of GQ(2,4)', the E6 Cartan "
                                          "cubic being that entropy formula; and "
                                          "the same abstract names the 15- and "
                                          "9-charge truncations as the doily "
                                          "GQ(2,2) and the grid GQ(2,1). The "
                                          "general theorem is older still: "
                                          "'Generalized Quadrangles and Cubic "
                                          "Forms', Communications in Algebra "
                                          "29(10) (2001), characterises the "
                                          "adjoint identities in terms of the "
                                          "incidence structure being a star or a "
                                          "GQ. The corpus search recorded below "
                                          "was accurate and the wording was "
                                          "hedged, but the framing invited a "
                                          "reading of novelty and that reading is "
                                          "wrong. See "
                                          "the_jordan_gq_series_is_published.py"),
