    ...
    if "--write" in sys.argv:
        ...
        with open(p, "w") as fh:
            json.dump({
                ...
                "valid": bool(ok),
                "nowProvedIntegrallyAndAtQ3": ("this file DEMONSTRATES the "
                                               "adjoint identity on 300 random "
                                               "matrices per prime at q = 5, 7, "
                                               "11 and explicitly EXCLUDES q = 3, "
                                               "because the gradient construction "
                                               "of # divides by small integers "
                                               "there. That exclusion is now "
                                               "unnecessary and the demonstration "
                                               "is superseded: Holotrade "
                                               "23b4d8a / a1013a6 / 6cbc5cf, "
                                               "analysis/the_rank_three_jordan_"
                                               "bridge_closes_at_q3.py, PROVES "
                                               "(X#)# = Pf(X) X as an identity of "
                                               "INTEGER POLYNOMIALS by exact "
                                               "sparse coefficient arithmetic, "
                                               "before any finite-field "
                                               "reduction, writing # as the "
                                               "co-Pfaffian gradient in the 15 "
                                               "independent alternating entries "
                                               "-- so it holds in every "
                                               "characteristic including three, "
                                               "and the rank dictionary is "
                                               "sanity-checked over F_3. Anyone "
                                               "quoting the q = 5,7,11 table "
                                               "below should quote that theorem "
                                               "instead. That file also records "
                                               "that W33-Theory already "
                                               "implements the 27-dimensional "
                                               "Albert J3(O) determinant as its "
                                               "E6 cubic, which supports rather "
                                               "than contradicts 9a202a2: the "
                                               "corpus holds the right object, "
                                               "and what 9a202a2 corrected was "
                                               "one parenthetical realization in "
                                               "one file"),
                ...
                "whyItMattersHere": ("the corpus's architecture layer already "
                                     ...
                                     "symplectic rank 3"),
                "priorArtSearchedIsNowSuperseded": ("the search reported below "
                    "was accurate when made, on 2026-09-05 at 11:17, but is no "
                    "longer current. Theory-of-Everything fdc9f1d75 (13:06 the "
                    "same day) proves that all 36 Schlaefli double-sixes cut "
                    "exact signed Pfaffian sections from the 27-coordinate E6 "
                    "Cartan cubic, C_E6 restricted to S_D = Pf_6 "
                    "coefficient-by-coefficient, and its boundary names the "
                    "Jordan/Severi interpretation directly. So the corpus now "
                    "holds the quaternion member explicitly, and holds it more "
                    "sharply than this file does -- 36 concrete sections rather "
                    "than an abstract rung. The statement below should be read as "
                    "a dated search result, not as a standing claim about the "
                    "corpus"),
